...
public final class Compat {
    ...
    public static net.minecraft.client.gui.widget.PlayerSkinWidget spiegelWidget(int breite, int hoehe) {
        ...
        var request = mc.getSkinProvider().fetchSkinTextures(mc.getGameProfile()).exceptionally(error -> fallback);
        java.util.function.Supplier<net.minecraft.client.util.SkinTextures> skin = () -> request.getNow(fallback);
        return new net.minecraft.client.gui.widget.PlayerSkinWidget(breite, hoehe, mc.getEntityModelLoader(), skin);
    }
